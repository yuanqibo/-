...
const builtInTemplates = [
  ...
  { key: 'access', name: 'Access资产标签', settings: { labelWidth: 60, labelHeight: 40, logoWidth: 0, logoHeight: 0, logoScale: 100, logoText: '', logoImage: '', qrSize: 22, qrTextGap: 0, contentScale: 100, offsetX: 0, offsetY: 0, fontSize: 10, fieldFontSizes: [], columns: 1, rows: 1, columnGap: 0, rowGap: 0, fields: ['id', 'name'], scanFields: [], customFields: '', showLogo: false, ownershipText: '此资产归Access集团所有' } }
]
    ...
    <section v-else class="asset-label-template-page">
      ...
      <div class="asset-label-template-right"><form class="asset-label-template-config-form first-template-config-form" @submit.prevent="saveLabel">
        ...
        <div class="asset-label-template-stage">
          ...
          <div v-else class="access-label-config-preview" :style="labelPreviewStyle" :aria-label="`配置1 ${labelSettings.labelWidth}*${labelSettings.labelHeight}mm 预览`"><div class="access-label-preview-card"><div class="access-label-preview-qr"><AssetQrGraphic text="资产编码:010100012" /></div><strong class="access-label-preview-code">010100012</strong><strong class="access-label-preview-name">MacBookProM1</strong><span class="access-label-preview-owner">{{ String(labelSettings.ownershipText || '此资产归Access集团所有') }}</span></div></div>
        </div>
