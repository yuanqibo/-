...
const routes: Array<RouteRecordRaw & { path: string }> = [
  ...
  { path: '/assets/handover', name: 'e2e-handover', component: () => import('../../../src/views/AssetHandoverPage.vue') },
...
const menuTree: TestMenu[] = [
  ...
  { id: 'assets', title: '资产', path: '/assets', pageKey: 'asset.portal.assets', order: 20, permissionCodes: ['asset:item:view'], featureCodes: ['PORTAL_ASSETS'], children: [
    ...
    { id: 'assetHandover', parentId: 'assets', title: '资产交接', path: '/assets/handover', pageKey: 'asset.portal.handover', order: 24, permissionCodes: ['asset:receive_return:view'], featureCodes: ['PORTAL_ASSETS'] },
    { id: 'stocktake', parentId: 'assets', title: '资产盘点', path: '/assets/stocktake', pageKey: 'asset.portal.stocktake', order: 25, permissionCodes: ['asset:stocktake:view'], featureCodes: ['PORTAL_ASSETS'] },
    { id: 'assetDisposals', parentId: 'assets', title: '资产处置', path: '/assets/disposals', pageKey: 'asset.portal.disposals', order: 26, permissionCodes: ['asset:disposal:view'], featureCodes: ['PORTAL_ASSETS'] },
