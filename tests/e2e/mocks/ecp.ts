...
const allPermissions = [
  ...
  'asset:inbound:view', 'asset:inbound:cancel', 'asset:receive_return:view', 'asset:borrow_return:view', 'asset:stocktake:view', 'asset:stocktake:create', 'asset:stocktake:update',
